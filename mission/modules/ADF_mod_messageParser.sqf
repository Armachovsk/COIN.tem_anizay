...
********************************************************************************
This Module will create and log hint messages using predefined templates. It
...
or: : ["Cmd", "A1", "Stand by for traffic. Over."] call ADF_fnc_MessageParser; sleep 10;
Output on Screen: "ALPHA-1 this is MOTHER. Stand by for traffic. Over."
