...
Script: Vehicle Cargo Script (BLUEFOR) - Car Marine Recon Infantry - CUP
Author: Whiztler
Script version: 1.0

Game type: n/a
File: ADF_vCargo_B_CUP_CarMRI.sqf
**********************************************************************************
INSTRUCTIONS::
...
_v addMagazineCargoGlobal ["CUP_30Rnd_556x45_Stanag", 20];
_v addMagazineCargoGlobal ["CUP_200Rnd_TE4_Red_Tracer_556x45_M249", 3]; // M249
_v addMagazineCargoGlobal ["CUP_15Rnd_9x19_M9", 4];// 1911 Side arm

// Launchers
_v addWeaponCargoGlobal ["CUP_launch_M136", 1];
