...
Script: Vehicle Cargo Script (BLUEFOR) - Car Infantry Fire Team
Author: Whiztler
Script version: 2.03
...
_v addMagazineCargoGlobal [_ADF_INF_primaryWeaponMag, 35];
_v addMagazineCargoGlobal [_ADF_INF_primaryWeaponMag_LMG, 4]; // LMG

// Launchers
_v addWeaponCargoGlobal [_ADF_INF_tube_Lite, 2];

// Rockets/Missiles
if (!ADF_mod_ACE3 && {!ADF_modded}) then {_v addMagazineCargoGlobal ["NLAW_F", 2]};
...
// GL Ammo
_v addMagazineCargoGlobal [_ADF_INF_40mike, 6];
if ADF_mod_ACE3 then {
...
// Grenades
_v addMagazineCargoGlobal [_ADF_INF_handgrenade, 10]; 	 
