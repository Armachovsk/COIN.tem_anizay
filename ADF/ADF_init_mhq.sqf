...
// Reporting
diag_log "ADF rpt: Init - executing: ADF_init_mhq.sqf";
...
// Init
ADF_MHQ_respawnTime = round ((_this # 1) * 60);
ADF_MHQ_respawnCount	= _this # 2;
ADF_MHQ_vehicle = _this # 3;
ADF_MHQ_BuildTime = _this # 4;
ADF_MHQ_PackUpTime = _this # 5;
